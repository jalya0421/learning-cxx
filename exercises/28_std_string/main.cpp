...
int main(int argc, char **argv) {
    ...
    ASSERT((!std::is_same_v<decltype(hello), decltype(world)>), "Fill in the missing type.");
    ASSERT((!std::is_same_v<decltype(world), decltype(hello)>), "Fill in the missing type.");
    // TODO: 将 `?` 替换为正确的字符串
